...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 07 Kas 2025, 09:40:15
...
(6, '2025_11_07_072641_kullanici_tablosu_olustur', 1),
(8, '2025_11_07_081410_yetki_alani_ekle', 2),
(9, '2025_11_07_083053_veriler_tablosu_olustur', 3);
...
ALTER TABLE `uyeler`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uyeler_e_posta_unique` (`e_posta`);
